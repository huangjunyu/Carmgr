...
//        settingImg = (ImageView)findViewById(R.id.my_msg_img);
//        accountRl = (RelativeLayout)findViewById(R.id.my_account_rl);
...
//                if (sharedPreferences.getString("TOKEN",null) == null){
//                    Intent loginIntent = new Intent(personalActivity.this, LoginBaseFragmentActivity.class);
