                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        try {
                            ...
                            if (TextUtils.equals(jsonObject.getString("opt_state"), "success")) {
                                ...
                                intent.setAction("action.enter_success");
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(MerchantEnterFragmentActivity.this);
                                builder.setTitle(MerchantEnterFragmentActivity.this.getString(R.string.hint))
                                        .setMessage(MerchantEnterFragmentActivity.this.getString(R.string.login_fail))
                                        .setPositiveButton(MerchantEnterFragmentActivity.this.getString(R.string.i_know),
