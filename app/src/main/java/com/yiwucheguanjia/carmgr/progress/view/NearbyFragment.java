    ...
    public void onLocationChanged(AMapLocation amapLocation) {
        if (mListener != null && amapLocation != null) {
            if (amapLocation != null
                ...
                aMap.moveCamera(CameraUpdateFactory.zoomTo(20));
                Log.e("经纬度",amapLocation.getLongitude() + "," + amapLocation.getLatitude());
            } else {
...
//            marker.setPosition(new LatLng(23.121066,113.390571));
//            aMap.invalidate();
            marker.setZIndex(2);
        }
        marker.setZIndex(0);
                    ...
                    if (mCloudItems != null && mCloudItems.size() > 0) {
                        ...
                        for (int i = 0; i < mCloudItems.size(); i++) {
                            ...
                            if (mCloudItems.get(i).getCloudImage().size() > 0) {
                                ...
                                Log.e("price", mCloudItems.get(i).getCustomfield().put("price", "5"));
                            } else {
                                serviceBean = new ServiceBean();
                                serviceBean.setHeaderUrl("url");
                                HashMap<String, String> positionMap1 = new HashMap<>();
                                positionMap1.put("kk", "kw");
                                serviceBean.setServicePrice(mCloudItems.get(i).getCustomfield().put("price", "5"));
                                Log.e("price", mCloudItems.get(i).getCustomfield().put("price", "5"));
