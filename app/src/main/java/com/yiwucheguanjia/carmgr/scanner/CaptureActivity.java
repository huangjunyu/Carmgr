...
import com.yiwucheguanjia.carmgr.scanner.camera.CameraManager;
import com.yiwucheguanjia.carmgr.scanner.common.BitmapUtils;
import com.yiwucheguanjia.carmgr.scanner.decode.BitmapDecoder;
import com.yiwucheguanjia.carmgr.scanner.decode.CaptureActivityHandler;
import com.yiwucheguanjia.carmgr.scanner.view.ViewfinderView;
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
				case PARSE_BARCODE_SUC: // 解析图片成功
					...
					bunble.putString("scan_result", message);
					intent1.putExtras(bunble);
					activityReference.get().setResult(20, intent1);
